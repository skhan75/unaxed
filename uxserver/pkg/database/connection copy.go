...
func GetDBDataSourceName1() (string, error) {
...
func GetDBConnection1(dsn string) (*sql.DB, error) {
...
func BuildDBURL1(username, password, host string, port int, dbName string) string {
