...
export const UserProfile: React.FC<any> = () => {
    ...
    const [isUserProfile, setIsUserProfile] = React.useState<boolean>(true);
            ...
            {!loading && (
                <div className="profile-page-container">
                    <div className="column slim">
                        <UserProfileInfo user={user} userProfileData={viewProfileData} isUserProfile />
                    </div>
                    <div className="column wide">
                        <UserProfileContent user={user} userProfileData={viewProfileData} isUserProfile />
                    </div>
                </div>
            )}
